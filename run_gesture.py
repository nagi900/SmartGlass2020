...
cv2.imwrite('ImgLeft.png',BrackImg)
cv2.imwrite('ImgRight.png',BrackImg)
ImgLeft = cv2.imread("ImgLeft.png")
ImgRight = cv2.imread("ImgRight.png")
...
while hasFrame:
    ...
    if points is not None:
        ...
        #frameへの書き込み
        #裏表を記述
        cv2.putText(ImgLeft,ForB,(0,20),font,1,(200,255,200),3)
        #手のひらの左右の動きを記述
    ...
    cv2.imshow(ACTWIN_L_NAME,ImgLeft)
